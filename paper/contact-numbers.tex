...
No contact number, and no kissing number, appears to have been formalized in any proof
assistant before.
...
The development is $60$ modules and $50\,810$ lines. The mathematics is $16$ of those
modules and $9\,347$ lines: the definitions, the lemmas of \S\ref{sec:arsenal}, the
reductions and their soundness proofs, and \texttt{IntervalBP}. The other $44$ modules,
$41\,463$ lines and $12.7$\,MB, are machine-emitted --- the certificates of
\S\ref{sec:seven}, the serialized trees of \S\S\ref{sec:eight}--\ref{sec:nine}, the
Positivstellensatz witnesses, and the branch-and-prune subdivisions. There are $4\,445$
kernel evaluation sites (\texttt{decide +kernel}) and no other computational steps.
